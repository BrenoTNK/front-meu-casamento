...
const Flower = () => {
  ...
  return (
    <Container fluid className="overflow-auto">
      <Row>
        ...
        <Col className="p-4" xs={12} sm={12} md={12} lg={6} xl={6} xxl={6}>
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            voluptates voluptatibus nostrum accusamus, quasi magnam eum incidunt
            molestias ducimus id molestiae nulla ex. Consectetur harum soluta
            blanditiis explicabo neque dolorem!
          </p>
          <h4 className="fw-bold d-flex justify-content-between">
            <span>
              <AntDesign name="star" size={32} color="#f0ad4e" />
              4,5
            </span>
            <span>
              <span
              ...
              {flower.sale?.value
                ? ` R$${formatNumberBR(
                    (flower.value * (100 - flower.sale.value)) / 100
                  )}`
                : ""}
              /{flower.uni}
            </span>
      ...
      <Row className="p-2">
        <Col
          className="d-flex justify-content-between mr-2 ml-2"
          xs={12}
          sm={12}
          md={12}
          lg={12}
        ...
        >
          ...
          <div className="d-flex">
            <AntDesign
              ...
              size={32}
              style={{
                color: quantity > 1 ? "#161718" : "#868e96",
                marginRight: 16,
              }}
              onPress={() => {
                if (quantity > 1) {
