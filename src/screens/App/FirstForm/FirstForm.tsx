...
import { createMarriageService } from "@src/services/marriageService";
...
const FirstForm = () => {
  ...
  const onSubmit = (data: any) => {
    console.log(data);
    if (page === 3) {
      createMarriageService(api, { ...data, userId: user.id });
        ...
        return (
          <Col>
            ...
            <SelectButtons
              ...
              className="mb-2"
              rules={{
                required: "Local do casamento é obrigatório",
                minLength: 1,
              }}
              itens={[
                { value: "", label: "" },
      ...
      <Container fluid className="overflow-auto">
        <Col className="p-5">
          <h2 className="text-center mb-5 fw-bold">
            Precisamos de alguns dados sobre o casamento
          </h2>
